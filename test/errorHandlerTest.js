...
describe("manageTailErrors", function() {
  ...
  it("should return error when invalid count is given", function() {
    inputData = {option : "c" ,count : "aa3" , files: ["numbers"]};
